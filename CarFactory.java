...
public class CarFactory {
	 ...
	 *
	 * @param isoCountryCode    the ISO Country Code which must be at least 3
	 *                          characters, of type {@link String}
	 * @param parts             the list of <code>CarPart</code> objects the factory
	 *                          uses to produce cars, of type {@link List}
	 * @param numberOfEmployees the number of employees employed at the factory, of
	 *                          type int
	 * @throws IllegalArgumentException is thrown if numberOfEmployees is less than
	 *                                  10 or the ISO country code is less than 3
	 *                                  characters
	 * 
	...
	public List<CarPart> getParts() {
		// TODO Implement the method getParts
		return null;
	}
	...
	public String getIsoCountryCode() {
		// TODO Implement the method getIsoCountryCode
		return null;
	}
	...
	public int getNumberOfEmployees() {
		// TODO Implement the method getNumberOfEmployees
		return 0;
	}
	...
	public int getNumberOfEngineers() {
		// TODO Implement the method getNumberOfEngineers
		return 0;
	}
}