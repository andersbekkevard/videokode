...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Random objektet er et objekt du lager kun 1 gang og kaller på det med funkjsoner hver gang du trenger en verdi
        ...
        // Funksjonen gir oss intervallet 0 til og med 5, så vi plusser på 1 for å få intervallet 1 til 6
