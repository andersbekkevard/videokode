...
public class Pizzeria {
    ...
    public static void write(List<PizzaRecipe> pizzaRecipes, OutputStream outputStream) throws IOException {
        // Begynn å skriv vanlig så bruke Throws istedenfor try catch. Si så man så må ha try catch der man kaller fra isteden
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(outputStream));
        for (PizzaRecipe r : pizzaRecipes) {
            String newEntry = r + "\n";
            writer.write(newEntry);
            // writer.write(r.toString() + "\n"); // Her må vi hjelpe med å gi toString eksplisitt
        }
        writer.flush();
        writer.close();
    }
    ...
    public static void otherWrite(List<PizzaRecipe> pizzaRecipes, OutputStream outputStream) throws IOException {
        // Fortell man så kan skrive direkte til outputstream, men at man da må omgjøre til bytes
        for (PizzaRecipe r : pizzaRecipes) {
            String newEntry = r + "\n";
    ...
    public static void main(String[] args) {
        ...
        try (OutputStream outputStream = new PrintStream("pizzaRecipes.txt")) {
        ...
        try (OutputStream outputStream = new PrintStream("otherPizzaRecipes.txt")) {
