...
public class Wrappers {
	...
	public static void main(String[] args) {
		...
		// Her ser vi at Java automatisk pakker de primitive typene inn i
		// wrapper-klassene
		int heltall = 5;
		...
		// Vi kan nå gjenkjenne at String også har stor forbokstav, og er en klasse på
		// samme måte, som inneholder flere chars
